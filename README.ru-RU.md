...
- [x] Движок проверки (обнаружение аномалий)
...
Вклад приветствуется. Сначала прочитайте [PLAN.md](PLAN.md) и [CONTRIBUTING.md](CONTRIBUTING.md) и следуйте рабочему процессу только-PR: **никогда не пушите напрямую в `main` / `dev`**.
