...
### Способ 1 — Отдайте ссылку вашему ИИ-ассистенту (проще всего)
Скопируйте это сообщение и вставьте его в вашего ИИ-ассистента (WorkBuddy, Claude, ChatGPT, ...) :

> Настройте этот проект для меня: https://github.com/BerryUIKI/Axiara
> 1. Получите код и инициализируйте его — проведите меня по настройке на русском (язык, хранение, источник данных).
> 2. Когда будет готово, скажите, что я могу попросить.

Дальше просто отвечайте на его вопросы. Вот и всё.

### Способ 2 — Скачайте файлы, затем используйте ИИ-ассистента
1. На этой странице нажмите зелёную кнопку **Code** → **Download ZIP** (или скачайте архив релиза, если он есть).
2. Распакуйте папку в любое место на компьютере.
3. Откройте эту папку в ИИ-ассистенте и скажите: *"Настройте этот проект и проведите меня по настройке."*
4. Отвечайте на вопросы — готово.
