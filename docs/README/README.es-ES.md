...
**Leer este documento en:** [English](../README.md) · [简体中文](../README.zh-CN.md) · [繁體中文](README.zh-TW.md) · [日本語](README.ja-JP.md) · [한국어](README.ko-KR.md) · [Français](README.fr-FR.md) · [Deutsch](README.de-DE.md) · **Español** · [Português](README.pt-BR.md) · [Русский](README.ru-RU.md)
...
Las contribuciones son bienvenidas. Lea primero [PLAN.md](PLAN.md) y [CONTRIBUTING.md](CONTRIBUTING.md) y siga el flujo de trabajo solo-PR: **nunca haga push directo a `main` / `dev`**.
